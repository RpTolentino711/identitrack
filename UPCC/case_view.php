...
<div id="aiFloatingBubble" onclick="toggleAiDrawer()" style="position:fixed;bottom:24px;right:24px;z-index:100005;cursor:pointer;display:flex;align-items:center;gap:14px;background:rgba(15, 23, 42, 0.94);backdrop-filter:blur(20px);color:#fff;padding:8px 22px 8px 12px;border-radius:50px;box-shadow:0 14px 45px rgba(14, 165, 233, 0.45), 0 0 25px rgba(99, 102, 241, 0.35);border:1px solid rgba(56, 189, 248, 0.6);font-family:var(--font);font-weight:700;font-size:14px;letter-spacing:0.3px;transition:all 0.4s cubic-bezier(0.34, 1.56, 0.64, 1);" onmouseover="this.style.transform='translateY(-6px) scale(1.05)';this.style.borderColor='rgba(56, 189, 248, 0.95)';" onmouseout="this.style.transform='translateY(0) scale(1)';this.style.borderColor='rgba(56, 189, 248, 0.6)';">
  ...
  <div style="flex:1;padding:20px;overflow-y:auto;padding-bottom:40px;">
    ...
    <div id="ai-drawer-initial-state" style="text-align: center; padding: 2rem 1rem;">
      ...
      <div style="font-size: 0.73rem; color: #64748b; margin-top: 1.25rem; font-weight: 500;">
        Advisory decision support. Final authority remains with UPCC.
      </div>
    </div>
    ...
    <div id="ai-drawer-result-card" style="display: none;">
      <div style="border-left: 4px solid #38bdf8; background: linear-gradient(145deg, rgba(15, 23, 42, 0.85), rgba(9, 14, 28, 0.95)); border-radius: 18px; padding: 1.35rem; margin-bottom: 1.25rem; border: 1px solid rgba(56, 189, 248, 0.25); box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
        ...
        <div style="font-size: 0.73rem; color: #94a3b8; line-height: 1.45; background: rgba(56, 189, 248, 0.08); border: 1px solid rgba(56, 189, 248, 0.2); border-radius: 10px; padding: 10px 12px;">
          ℹ️ <em>Model confidence is calculated from TF-IDF pattern similarity. UPCC panel retains 100% final decision authority.</em>
        </div>
      </div>
