                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _handbookItem(
                                ...
                                desc: 'A formal warning notice is dispatched to your guardian\'s email address.',
                                isCritical: false,
                              ),
                              const Divider(height: 16),
                              _handbookItem(
                                step: '3rd Strike (Same)',
                                title: 'Section 4 Escalation (3 Same Minors)',
                                desc: '3 minor offenses of the SAME type automatically trigger Section 4 Escalation to the UPCC.',
                                isCritical: true,
                              ),
                              const Divider(height: 16),
                              _handbookItem(
                                step: '3rd Strike (Diff)',
                                title: 'Student App Warning Alert',
                                desc: 'Warning alert issued on your app that 1 more minor of any type will trigger Section 4.',
                                isCritical: false,
                              ),
                              const Divider(height: 16),
                              _handbookItem(
                                step: '4th Strike (Diff)',
                                title: 'Section 4 Escalation (4 Diff Minors)',
                                desc: '4 minor offenses of DIFFERENT types automatically trigger Section 4 Escalation to the UPCC.',
                                isCritical: true,
                              ),
                            ],
                          ),
